...
<div class="pd-20">
    ...
    <input type="text" name="teacherId" id="teacherId" value="" width="0" height="0" hidden="hidden">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tr>
            <th></th>
            <td>
                <a onclick="sibmit()"  class="btn btn-success radius" id="teacher-password-save" name="teacher-password-save">确定</a>
            </td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript">
    ...
    function sibmit(){
        ...
        var url = '${base}/teacher/updatePassword';
        var data = {
