...
<html>
	...
	<body>
		...
		<form action="<%=path%>/student/add" class="form-horizontal">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="studentSex" class="form-control input-sm" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="studentPassword" class="form-control input-sm" />
						</div>
					</div>
