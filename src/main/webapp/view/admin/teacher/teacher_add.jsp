...
<form action="<%=path%>/teacher/add" class="form-horizontal">
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="teacherSex" class="form-control input-sm" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="teacherPhone" class="form-control input-sm" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">教师地址</label>
                <div class="col-sm-9">
                    <input type="text" name="teacherAddress" class="form-control input-sm" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">教师密码</label>
                <div class="col-sm-9">
                    <input type="password" name="teacherPassword" class="form-control input-sm" />
                </div>
            </div>
            <div class="form-group">
