...
<form action="<%=path%>/course/Update" class="form-horizontal">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="courseId" class="form-control input-sm" readonly="readonly" value="${course.courseId}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">课程名称</label>
                <div class="col-sm-9">
                    <input type="text" name="courseName" class="form-control input-sm" value="${course.courseName}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">课程类型</label>
                <div class="col-sm-9">
                    <input type="text" name="courseType" class="form-control input-sm" value="${course.courseType}"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="academicYear" class="form-control input-sm" value="${course.academicYear}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">学期</label>
                <div class="col-sm-9">
                    <input type="text" name="semester" class="form-control input-sm" value="${course.semester}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">上课时间</label>
                <div class="col-sm-9">
                    <input type="text" name="time" class="form-control input-sm" value="${course.time}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">上课地点</label>
                <div class="col-sm-9">
                    <input type="text" name="place" class="form-control input-sm" value="${course.place}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">学时</label>
                <div class="col-sm-9">
                    <input type="text" name="creditHour" class="form-control input-sm" value="${course.creditHour}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">学分</label>
                <div class="col-sm-9">
                    <input type="text" name="credit" class="form-control input-sm" value="${course.credit}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">考试类型</label>
                <div class="col-sm-9">
                    <input type="text" name="examType" class="form-control input-sm" value="${course.examType}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">计划人数</label>
                <div class="col-sm-9">
                    <input type="text" name="planNumber" class="form-control input-sm" value="${course.planNumber}"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">已选人数</label>
                <div class="col-sm-9">
                    <input type="text" name="selectedNumber" class="form-control input-sm" value="${course.selectedNumber}"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-3 col-sm-offset-2">
            ...
            <a class="btn btn-warning" href="/xuanke/view/course/course_list.jsp">返回上一级</a>
        </div>
    </div>
</form>
</body>
