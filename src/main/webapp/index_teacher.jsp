...
<head>
    ...
    <script>$("#exit").on("click",function(){  //将退出按钮的id设置为exit，然后将这个函数在公共文件里面即可
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span class="user-info">
							<small>${currentTeacher.teacherName},欢迎</small>
						</span>
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li class="divider"></li>
                        <li>
                            <a href="tp_change.jsp" target="mainframe">
                        ...
                        <li class="divider"></li>
                        <li>
<%--                            <a href="login.jsp" target="mainframe" name="exit">--%>
<%--                                <i class="icon-off"></i>--%>
<%--                                退出--%>
<%--                            </a>--%>
                            <a href="<%=path%>/teacher/loginOut">
                                <input type="button" class="btn btn-danger" value="退出" id="exit"  />
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li><a href="<%=path%>/teacher/teacherInfo" target="mainframe">
                            <i class="icon-double-angle-right"></i> 个人信息 </a></li>
                        <li><a href="<%=path%>/course/teached/listAll" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 查看任课信息 </a></li>
                        <li><a href="<%=path%>/teacher/queryStudentInfoList" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 查看学生信息 </a></li>
                        <li><a href="<%=path%>/teacher/queryScoreList" target="mainframe">
                            <i class="icon-double-angle-right"></i> 成绩管理 </a></li>
                        <li><a href="<%=path%>/news/teacher/listAll" target="mainframe">
                            <i class="icon-double-angle-right"></i>校园新闻 </a></li>
                    </ul>
                </li>
