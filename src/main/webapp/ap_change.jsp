...
<div class="pd-20">
  <%--<form class="Huiform" id="loginform" action="${base}/teacher/updatePwd" method="post">--%>
    <input type="text" name="adminId" id="adminId" value="" width="0" height="0" hidden="hidden">
    ...
    <table class="table table-border table-bordered table-bg">
      ...
      <tbody>
        ...
        <tr>
          <th></th>
          <td>
            <a onclick="sibmit()"  class="btn btn-success radius" id="admin-password-save" name="admin-password-save"> 确定</a>
          </td>
        </tr>
      </tbody>
    </table>
...
<script type="text/javascript">
    ...
    function sibmit(){
        ...
        var url = '${base}/admin/updatePassword';
        var data = {
