                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span class="user-info">
							<small>${currentStudent.studentName},欢迎</small>
						</span>
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li class="divider"></li>
                        <li>
                            <a href="sp_change.jsp" target="mainframe">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="<%=path%>/student/loginOut" target="mainframe">
                                <i class="icon-off"></i>
                                退出
                            </a>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li><a href="<%=path%>/student/studentInfo" target="mainframe"> <i
                                class="icon-double-angle-right"></i>个人信息 </a></li>
                        <li><a href="view/course/course_select.jsp" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 网上选课 </a></li>
                        <li><a href="<%=path%>/course/selected/listAll" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 查看选课信息 </a></li>
                        <li><a href="<%=path%>/student/queryScoreList" target="mainframe"> <i
                                class="icon-double-angle-right"></i>学生成绩 </a></li>
                        <li><a href="<%=path%>/news/student/listAll" target="mainframe"> <i
                                class="icon-double-angle-right"></i>校园新闻 </a></li>
                    </ul>
                </li>
            </ul>
